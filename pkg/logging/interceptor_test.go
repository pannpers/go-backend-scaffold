...
func TestNewAccessLogInterceptor(t *testing.T) { //nolint:gocyclo // TODO: Complex test function with many scenarios
	t.Parallel()
...
func TestAccessLogInterceptor_HeaderExtraction(t *testing.T) { //nolint:gocyclo // TODO: Complex test function with many scenarios
	t.Parallel()
